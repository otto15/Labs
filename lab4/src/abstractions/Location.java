...
public abstract class Location implements Illuminated {
    ...
    public void addLightSource(LightSource newLightSource) {
        if (newLightSource == null) {
            throw new IllegalArgumentException("Некоректное искусственный источник света");
        }
    ...
    public void removeLightSource(LightSource lightSourceBeingDeleted) {
        if (lightSourceBeingDeleted == null) {
            throw new IllegalArgumentException("Некоректное искусственный источник света");
        }
    ...
    public static class LightInformationPair {
        ...
        public LightInformationPair(LightSource lightSource, Double percentageOfTotalLightning) {
